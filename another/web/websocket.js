...
function messageShow(data) {
    ...
    cpuInfo.innerText = info.cpu ? `${info.cpu.toFixed(2)}%` : "disconnect";
    memInfo.innerText = info.mem ? `${info.mem.toFixed(2)}%` : "disconnect";
    batInfo.innerText = info.bat ? `${info.bat.toFixed(2)}%` : "disconnect";
}
